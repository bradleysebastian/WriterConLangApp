...
//        newSyll.createSyllable(newSyll);
        newSyll = new Syllable(-1,"a","ah","Any","Regular","none",ZonedDateTime.now().toLocalDateTime().toString(),false,false,Syllable.FollowSyll.Any);
        newSyll.createSyllable(newSyll);
        newSyll = new Syllable(-1,"i","ee","Any","Regular","none",ZonedDateTime.now().toLocalDateTime().toString(),false,false,Syllable.FollowSyll.Any);
        newSyll.createSyllable(newSyll);
        newSyll = new Syllable(-1,"u","oo","Any","Regular","none",ZonedDateTime.now().toLocalDateTime().toString(),false,false,Syllable.FollowSyll.Any);
        newSyll.createSyllable(newSyll);
        newSyll = new Syllable(-1,"e","eh","Any","Regular","none",ZonedDateTime.now().toLocalDateTime().toString(),false,false,Syllable.FollowSyll.Any);
        newSyll.createSyllable(newSyll);
        newSyll = new Syllable(-1,"o","oe","Any","Regular","none",ZonedDateTime.now().toLocalDateTime().toString(),false,false,Syllable.FollowSyll.Any);
        newSyll.createSyllable(newSyll);
